...
// Renderiza o contrato em formato de documento para impressão, PDF e assinatura.
          ...
          <div className="contract-body">
            ...
            <ol className="contract-clauses">
              <li>
                ...
                de {documentData.consolidatedDebtAmount}, referente às cotas condominiais vencidas
                e não pagas de {documentData.debtPeriod}, da unidade {documentData.unit} do{" "}
                {documentData.condominium}, valor este que já contempla atualização monetária,
                multa, juros moratórios e honorários, consolidando-se como capital único da
                presente confissão de dívida.
              </li>
              ...
              <li>
                ...
                {documentData.firstInstallmentDate} e as demais no mesmo dia dos meses
                subsequentes.
              </li>
              ...
              <li>
                O DEVEDOR compromete-se e obriga-se, a contar da data de assinatura desta
                negociação até o seu integral cumprimento, a efetuar pontualmente o pagamento de
                todas as suas cotas condominiais vincendas que não foram incluídas na negociação. O
                inadimplemento de qualquer das cotas acarretará a rescisão automática desta
                negociação.
              </li>
              ...
              <li>
                ...
                Havendo a sua rescisão todos os pagamentos porventura efetuados deverão ser
                imputados a partir da cota mais antiga para a mais recente, sendo retomada a
                cobrança do saldo residual acrescido de multa de 10% (dez por cento) e honorários
                advocatícios.
              </li>
              ...
              <li>
                ...
                14.063/2020, o pagamento da primeira parcela da negociação importará em
                concordância do DEVEDOR quanto a todos os termos deste acordo, configurando ato
                jurídico perfeito e eficaz, com renúncia a qualquer questionamento sobre a origem,
                validade ou exigibilidade da dívida ora confessada.
              </li>
            </ol>
          </div>

          <ContractPageFooter documentData={documentData} />
        </section>

        <section className="contract-page contract-page--continued">
          <div className="contract-body">
            <ol className="contract-clauses contract-clauses--continued">
              <li>
                A presente confissão e reconhecimento do débito pelo DEVEDOR interrompe a
                prescrição relativamente ao montante ora consolidado. O prazo prescricional passará
                a fluir novamente, em sua integralidade, somente a partir do inadimplemento de
                qualquer obrigação prevista neste acordo, hipótese em que se tornará exigível o
                saldo devedor então existente, deduzidos os pagamentos eventualmente realizados.
              </li>
              ...
              <li>
                ...
                adimplemento, ciente de que a falsidade ou inexatidão desta declaração poderá
                ensejar o imediato cancelamento do presente acordo.
              </li>
...
function ContractPageFooter({ documentData }) {
  return (
